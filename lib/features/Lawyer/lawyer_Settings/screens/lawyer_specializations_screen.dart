...
class LawyerSpecializationsScreen extends StatefulWidget {
  ...
  @override
  State<LawyerSpecializationsScreen> createState() => _LawyerSpecializationsScreenState();
}

class _LawyerSpecializationsScreenState extends State<LawyerSpecializationsScreen> {
  // -------------------------------
  // 🔹 Data
  // -------------------------------
